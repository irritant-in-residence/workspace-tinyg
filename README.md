  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspacePymonster) {
        ...
        console.log("Workspace / TinyG just got loaded.", myWorkspacePymonster);
