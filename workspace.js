...
cprequire_test(["inline:com-chilipeppr-workspace-pymonster"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-pymonster", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-pymonster", // Make the id the same as the cpdefine id
        name: "Workspace / PYMonster", // The descriptive name of your widget.
        desc: `This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using PYMonster.`,
